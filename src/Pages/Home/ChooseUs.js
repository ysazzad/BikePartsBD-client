        ...
        <div className='container mx-auto'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-3 gap-4'>
                <div className='border-2'>
                    ...
                    <h4 className='text-2xl text-center text-orange-500'>Quick Delivery</h4>
                ...
                <div className='border-2'>
                    ...
                    <h4 className='text-2xl text-center text-orange-500'>Outstanding support</h4>
                ...
                <div className='border-2'>
                    ...
                    <h4 className='text-2xl text-center text-orange-500'>Secure checkout</h4>
